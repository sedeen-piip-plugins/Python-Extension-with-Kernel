...
namespace sedeen {
  namespace python {
    ...
    bool PythonObject::pyobject_to(PyObject* obj, sedeen::image::RawImage& image)
    {
      ...
      sedeen::ColorSpace color(sedeen::ColorModel::Grayscale, 8);
      bool isSigned = false;
      int depth = 0;
      switch (typenum)
      {
      case NPY_UBYTE:
        if (ndims == 3) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGB, sedeen::ChannelType::UInt8);
        }
        else if (ndims == 4) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGBA, sedeen::ChannelType::UInt8);
        }
        isSigned = false;
        depth = 8;
        break;
      case NPY_BYTE:
        if (ndims == 3) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGB, sedeen::ChannelType::Int8);
        }
        else if (ndims == 4) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGBA, sedeen::ChannelType::Int8);
        }
        isSigned = true;
        depth = 8;
        break;
      case NPY_USHORT:
        if (ndims = 2) {
          color = sedeen::ColorSpace(sedeen::ColorModel::Grayscale, sedeen::ChannelType::UInt16);
        }
        else if (ndims == 3) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGB, sedeen::ChannelType::UInt16);
        }
        else if (ndims == 4) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGBA, sedeen::ChannelType::UInt16);
        }
        isSigned = false;
        depth = 16;
        break;
      case NPY_SHORT:
        if (ndims = 2) {
          color = sedeen::ColorSpace(sedeen::ColorModel::Grayscale, sedeen::ChannelType::Int16);
        }
        else if (ndims == 3) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGB, sedeen::ChannelType::Int16);
        }
        else if (ndims == 4) {
          color = sedeen::ColorSpace(sedeen::ColorModel::RGBA, sedeen::ChannelType::Int16);
        }
        isSigned = true;
        depth = 16;
        break;
    ...
    bool PythonObject::pyobject_to(PyObject* obj, sedeen::ColorSpace& value)
    {
      //Not implemented
      return true;
    }
    ...
    PythonObject* PythonObject::pyobject_from(const sedeen::image::RawImage& image)
    {
      ...
      shape[1] = image.width();
      shape[2] = sedeen::bytesPerPixel(image.colorSpace());

      auto color = image.colorSpace();
      bool isSigned = sedeen::isSigned(color.channelType());
      char typenum; // = NPY_UBYTE;
      if (!isSigned) {
        switch (sedeen::bitsPerChannel(color)) {
        case 8:
          typenum = NPY_UBYTE;
          break;
        case 12:
    ...
    PythonObject* PythonObject::pyobject_from(const sedeen::ColorSpace& value)
    {
      //Not implemented
